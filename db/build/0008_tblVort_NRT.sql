...
CREATE TABLE [dbo].[tblVort_NRT](
	[lat] [float] NOT NULL,
	[lon] [float] NOT NULL,
	[time] [date] NOT NULL,
	[vort] [float] NULL,
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
 CONSTRAINT [PK_tblVort_NRT] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_tblVort_NRT_time_lat_lon] ON [dbo].[tblVort_NRT]
(
	[time] ASC,
	[lat] ASC,
	[lon] ASC
...
CREATE NONCLUSTERED INDEX [IX_tblVort_NRT_vort] ON [dbo].[tblVort_NRT]
(
	[vort] ASC
