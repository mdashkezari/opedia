...
"""GLODAP data Catalog Table"""
tableName = 'tblGLODAP'
rawFilePath = cfgv.rep_GLODAP_raw
rawFileName = 'GLODAPmetadata.xlsx'
############################
...
Distributor = 'NOAA - https://www.nodc.noaa.gov/ocads/oceans/glodap/GlopDV.html'
...
Study_Domain_ID_list = ['3'] * len(vars_metadata)
