...
rawFileName = cfgv.code_darwin_Ecosystem_raw + 'darwin_ecosystem_metadata.xlsx'
############################
DB_id = '91'
var_id_list = ['1265','1266','1267','1268','1269']
...
""" Strings """
DB='Opedia'
Table_Name = 'tblDarwin_Ecosystem'
Dataset_Name = 'tblDarwin_Ecosystem'#dataset_metadata.iloc[0]['dataset_short_name']
