...
rawFileName = cfgv.code_darwin_Ocean_Color_raw + 'darwin_ocean_color_metadata.xlsx'
############################
DB_id = '93'
var_id_list = ['1275','1276']
...
""" Strings """
DB='Opedia'
Table_Name = 'tblDarwin_Ocean_Color'
Dataset_Name = 'tblDarwin_Ocean_Color'#dataset_metadata.iloc[0]['dataset_short_name']
