...
rawFileName = cfgv.code_darwin_Nutrient_raw + 'darwin_nutrient_metadata.xlsx'
############################
DB_id = '92'
var_id_list = ['1270','1271','1272','1273','1274']
...
""" Strings """
DB='Opedia'
Table_Name = 'tblDarwin_Nutrient'
Dataset_Name = 'tblDarwin_Nutrient'#dataset_metadata.iloc[0]['dataset_short_name']
...
# cF.tblVariables(var_id_list,DB_list, Dataset_Name_list, short_name_list, long_name_list, unit_list,temporal_res_list, spatial_res_list, Temporal_Coverage_Begin_list, Temporal_Coverage_End_list, Lat_Coverage_Begin_list, Lat_Coverage_End_list, Lon_Coverage_Begin_list, Lon_Coverage_End_list, Grid_Mapping_list,Make_ID_list, Sensor_ID_list, Process_ID_list, Study_Domain_ID_list, keyword_list, comment_list)
