...
def genericDist(table, field, startDate, endDate, lat1, lat2, lon1, lon2, arg8_name, arg8_val, extV2, extVV2):
    def strToDate(str):
    ...
    args = [table, field, startDate, endDate, str(lat1), str(lat2), str(lon1), str(lon2), arg8_name, arg8_val]
