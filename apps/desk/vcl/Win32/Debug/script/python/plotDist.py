...
def plotDist(tables, variables, startDate, endDate, lat1, lat2, lon1, lon2, extV, extVV, extV2, extVV2, marker='-', msize=30, clr='purple'):
    p = []
    lw = 2
    w = 800
    h = 400
...
tic = time.clock()
plotDist(tables, variables, startDate, endDate, lat1, lat2, lon1, lon2, extV, extVV, extV2, extVV2)
toc = time.clock()
