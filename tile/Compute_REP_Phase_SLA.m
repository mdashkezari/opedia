...
function phase = Compute_REP_Phase_SLA(itnum,phase_range,Xres,Yres)
  save_path = '/nfs/micklab004/mdehghani/opedia_vault/tile/obs/rep/phase_sla/rep_phase_sla_%10.10d_%d_%d.mat';
  base_path = '/nfs/micklab004/mdehghani/opedia_vault/raw/obs/rep/uv_sla/rep_uv_sla_';
  lon_channel = 4;
  lat_channel = 5;
  V_channel = 1;
  U_channel = 2;
