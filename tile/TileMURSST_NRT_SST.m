...
function TileMURSST_NRT_SST(itnums);
  addpath('tile/');	
  for itnum=itnums
    disp(itnum);
    path = sprintf('/nfs/micklab004/mdehghani/opedia_vault/raw/obs/nrt/sst/nrt_sst_%d.nc', itnum);
	...
	if i==1
        ...
        save(sprintf('/nfs/micklab004/mdehghani/opedia_vault/tile/obs/nrt/sst/nrt_sst_%10.10d_%d_%d.mat',itnum,i,j), 'sst', 'lon', 'lat');
      end
    end
