...
function phase = Compute_NRT_Phase_SLA(itnum,phase_range,Xres,Yres)
  save_path = '/nfs/micklab004/mdehghani/opedia_vault/tile/obs/nrt/phase_sla/nrt_phase_sla_%10.10d_%d_%d.mat';
  base_path = '/nfs/micklab004/mdehghani/opedia_vault/raw/obs/nrt/uv_sla/nrt_uv_sla_';
  lon_channel = 4;
  lat_channel = 2;
  V_channel = 8;
  U_channel = 7;
